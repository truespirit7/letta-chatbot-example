...
async function getAgentMessages(req: NextApiRequest, { params }: { params: { agentId: string } }) {
    try {
...
async function sendMessage(req: NextRequest, { params }: { params: { agentId: string } }) {
